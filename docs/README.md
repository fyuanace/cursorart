...
| ② 左侧栏 | 顶：横向左 dock；下：文档树 | `#dockLeft` + `.layout__dockl` | 同上；隐藏笔记本见 [design/2026-09-03-file-tree-hide-notebook.md](design/2026-09-03-file-tree-hide-notebook.md) |
...
- 设置入口：顶栏 `#barPlugins` 菜单 →「cursor极简 设置」（侧栏工具显隐、文件树隐藏笔记本；样式里的链接样式、表格表头不加粗、块行间距；见 [design/2026-08-04-theme-settings.md](design/2026-08-04-theme-settings.md)）
